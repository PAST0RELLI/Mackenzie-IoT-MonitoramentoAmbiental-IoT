...
const char* MQTT_CLIENT_ID = "ESP32_Wokwi_Local2";
const char* TOPICO_TEMP = "TESTMACK1870/10419046/local2/temperatura";
const char* TOPICO_UMID = "TESTMACK1870/10419046/local2/umidade";
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    if (dhtSensor.getStatus() == DHTesp::ERROR_NONE) {
      ...
      Serial.printf("Local 2 -> Leitura Atual: Temp: %s°C | Umid: %s%%\n", tempString, umidString);
    } else {
